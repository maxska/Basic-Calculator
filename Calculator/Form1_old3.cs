...
namespace Calculator
{
    public partial class Form1 : Form
    {
        ...
        private void ioBox_TextChanged(object sender, EventArgs e)
        {
            ...
            //if(ioBox.Text[ ioBox.Text.Length - 1 ] == ',')
            //{
            //    ToggleOperatorButtons(false);
            //}
            ...
            if( LastWasAOperator(ioBox.Text) )
            {
                CommaButton.Enabled = false;
        ...
        private bool LastWasAComma(string inText)
        {
        ...
        private bool LastWasAOperator(string inText)
        {
